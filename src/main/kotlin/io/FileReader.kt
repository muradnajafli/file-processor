...
/**
 * Class that is resposible for reading file line by line and send each line as sequence item.
 */
class FileReader {
    /**
     * Read file line by line and transform it to sequence.
     * Do not read full file content and the transform it to sequence.
